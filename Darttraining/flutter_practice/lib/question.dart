//################################################ Practice 1 Question ######################################################################################################################################################################################################################################
void printquestion1(int? num) {
  List<String> questionnaire = [
    "[1] Write a program to print your name in Dart.",
    "[2] Write a program to print Hello I am “John Doe” and Hello I"
        '’'
        "am “John Doe” with single and double quotes.",
  ...
  if (num == null) {
    for (var questions in questionnaire) {
      print(questions);
    }
  } else {
    print(questionnaire[num]);
  }
}

//################################################ Practice 2 Question ##################################################################################################################################################################################################
void printquestion2(int? num) {
  List<String> questionnaire = [
...
void printquestion3(int? num) {
  ...
  List<String> questionnaire = [
    ...
    "[10] Write a function in Dart called isEven that takes a number as an argument and returns True if the number is even,\n     and False otherwise..",
...
void printquestion8(int? num) {
  ...
  List<String> questionnaire = [
    ...
    "[9] Write a Dart program that takes a list of integers as input, multiplies each integer by 2 asynchronously,\n    and then prints the modified list.",
