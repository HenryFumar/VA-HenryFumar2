import 'dart:io';
import 'dart:async';
import 'package:index/practice8_.dart' as practice8_question;
  ...
  do {
    try {
      ...
      if (number == 1) {
        ...
        practice8_question.question1();
      }
      //-----------------------------------------2------------------------------------------------//
      else if (number == 2) {
        question_number.printquestion8(1);
        practice8_question.question2();
      }
      //-----------------------------------------3------------------------------------------------//
      else if (number == 3) {
        question_number.printquestion8(2);
        await practice8_question.question3();
        print("====================================================");
      }
      //-----------------------------------------4------------------------------------------------//
      else if (number == 4) {
        question_number.printquestion8(3);
        await practice8_question.question4();
        print("====================================================");
      }
      //-----------------------------------------5------------------------------------------------//
      else if (number == 5) {
        ...
        Future<String> operation1 =
            practice8_question.question5('Operation 1', Duration(seconds: 3));
        Future<String> operation2 =
            practice8_question.question5('Operation 2', Duration(seconds: 1));
        Future<String> operation3 =
            practice8_question.question5('Operation 3', Duration(seconds: 2));
      ...
      //-----------------------------------------6------------------------------------------------//
        ...
        print(
            'The sum of 5 and 10 is: ${await practice8_question.question6(5, 10)} ');
        print("====================================================");
      }
      //-----------------------------------------7------------------------------------------------//
      else if (number == 7) {
        ...
        do {
          try {
            ...
            print(
                'the sum is: ${await practice8_question.question7(num1, num2)}');
            break;
          } catch (e) {
            print('Invalid Input');
          }
      ...
      //-----------------------------------------8------------------------------------------------//
        ...
        print('Sorted list: ${await practice8_question.question8(inputList)}');
        print("====================================================");
      }
      //-----------------------------------------9------------------------------------------------//
      else if (number == 9) {
        ...
        print(
            'Modified list: ${await practice8_question.question9(inputList)}');
        print("====================================================");
      }
      //-----------------------------------------10------------------------------------------------//
      else if (number == 10) {
        ...
        String reversedString = await practice8_question.question10(mystring);
